...
private fun SimplePanel.iconSvg(classname: String, pathD: String) {
    tag(TAG.SVG, className = "bi $classname me-2") {
        width = 16.px
        height = 16.px
