...
class AboutPageComponent : Component, KoinComponent {
    ...
    private fun SimplePanel.howToJoin() {
        ...
        p(
            "В клуб приветствуются студенты, имеющие базовый опыт в разработке ПО. " +
                    "Особенное внимание обращается студентам, учащихся на техническую, информационную специальность."
        )
